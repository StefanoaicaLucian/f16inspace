...
public class Renderer extends WindowAdapter implements GLEventListener, Observer {
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    pel = Libraries.getPEL();
    pel.registerGLAutoDrawable(drawable);
  ...
  public void display(GLAutoDrawable drawable) {
    ...
    glu.gluLookAt(cameraPosition.getPositionX(), cameraPosition.getPositionY(),
        cameraPosition.getPositionZ(),
        cameraPosition.getPositionX() + targetPosition.getPositionX(),
        targetPosition.getPositionY(),
        cameraPosition.getPositionZ() + targetPosition.getPositionZ(), 0.0f, 1.0f, 0.0f);
