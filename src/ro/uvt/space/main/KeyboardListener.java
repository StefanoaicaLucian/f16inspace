  ...
  public void keyPressed(KeyEvent e) {
    switch (e.getKeyCode()) {
      case VK_LEFT:
        ...
        System.out.println("cameraAngle: " + cameraAngle + " / sin: " + Math.sin(cameraAngle)
            + " / cos: " + Math.cos(cameraAngle));
      ...
      case VK_UP:
        cameraPosition.setPositionX(
            cameraPosition.getPositionX() + (float) (targetPosition.getPositionX() * fraction));
        cameraPosition.setPositionZ(
            cameraPosition.getPositionZ() + (float) (targetPosition.getPositionZ() * fraction));
        notifyObservers();
        break;
      ...
      case VK_9:
        associatedRenderer.changeParticleEffect(9);
        notifyObservers();
        break;

      case VK_0:
        associatedRenderer.changeParticleEffect(0);
        notifyObservers();
        break;
    }
  }
