...
Initially I wanted to generate random points inside or on the circle which forms the base of the cone but the generation of points inside or on a circle in three-dimensional space proved to be more difficult to implement than the generation of points inside or on the surface of a sphere.