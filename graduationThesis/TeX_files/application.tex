Particle systems can have a lot of different movement mechanisms and the best way to truly understand them is to implement some of them.

The simple application programming interface (API in abbreviated form) for 3D applications around which this thesis revolves offers four particle based graphical effects. Although it does not offer a vast number of graphical effects the API is designed with extensibility in mind. In other words new particle based graphical effects can be easily added to the next versions of the API.\\
